...
$this->title = 'Danh sách tin nổi bật trang chủ';
?>
<div class="list-item-index">
    <div class="topOption">
        <div class="remove-padding" style="width: 39%;">
            <ul class="filterPost">
                <li><a href="/app433/news-home">Tất cả</a></li>
                <li><a href="/app433/news-home?public=0">Tin ẩn</a></li>
            </ul>
        </div>
        <!--Input tìm kiếm-->
        <div class="search">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <div class="col-md-8 remove-padding">
                <h3 class="panel-title">Danh sách tin nổi bật trang chủ</h3>
            </div>
            <div class="clearfix"></div>
        </div>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="/app433/news-home/update?id=<?= $id ?>&redirect=post">Chỉnh sửa</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
