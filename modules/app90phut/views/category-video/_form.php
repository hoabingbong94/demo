    ...
    <div class="panel-body">
        <div class="col-md-12">
            <div class="frm-group field-CategoryName">
                ...
                <?= $form->field($model, "Name")->input('text', array('id' => 'Name'))->label(false) ?>
            </div>

            <div class="frm-group field-OrderIndex">
                <label class="control-label" for="OrderIndex">Thứ tự sắp xếp</label>
                <?= $form->field($model, "OrderNumber")->input('number', array('id' => 'OrderIndex'))->label(false) ?>
            </div>
            <div class="col-md-4 bootstrap-switch">
                <?=
                        $form->field($model, 'Active', array('template' => '<span class="textCheckBox">Hiển thị</span><br/><br/>{input}{label}'))
